...
class ParamBuilder
{
    ...
    {
        $this->add_field_checkbox('add_icon', esc_html__('Add icon?', 'realtyspace'));
    ...
    private function add_svg_fieldset($icon_params)
    {
        $icon_params[] = [
            'type' => 'iconpicker',
            'heading' => esc_html__('Icon', 'realtyspace'),
            'param_name' => 'icon_svg',
            'settings' => [
                'emptyIcon' => false,
                'type' => 'svg',
        ...
        $icon_params[0]['value'][esc_html__('Realtyspace icons', 'realtyspace')] = 'svg';
    ...
    private function register_autocomplete_filter($shortcode, $field, array $params = [])
    {
        ...
        add_filter("vc_autocomplete_{$shortcode}_{$field}_render", 'vc_include_field_render');
    }
